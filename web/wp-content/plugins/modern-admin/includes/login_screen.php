...
if (isset($_POST['save_login_screen'])){
    ...
    if(isset($_POST['login_screen'])){
	    if(!isset($_POST['login_screen']['active']))
		    $_POST['login_screen']['active']=0;
        if(!isset($_POST['login_screen']['fullpage']))
            $_POST['login_screen']['fullpage']=0;
...
<div class="wrap">
    ...
    <form action="" method="post">
        <table class="form-table">
            ...
            <tr valign="top">
                <?php $field="active";
                $val=(isset($Options['login_screen'][$field]))? $Options['login_screen'][$field]:1;
                ?>
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top">
                    ...
                    ?>
                    <th scope="row"><label for="<?php echo $field;?>"><?php _e('Full Page background Image',self::LANG);?></label></th>
                    <td>
                        <input type="checkbox" id="<?php echo $field;?>" value="1" name="login_screen[<?php echo $field;?>]" <?php checked($val,1)?>>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                $val=(isset($Options['login_screen'][$field]))? esc_html($Options['login_screen'][$field]):'';
                $getImageHeight = "";
                if ( isset($_POST['reset_login_screen']) && !empty($_POST['reset_login_screen']) )
                {
                    $getImageHeight = "";
                }else{
                    if ( isset($_POST['login_screen']['height']) )
                    {
                        $getImageHeight = $_POST['login_screen']['height'];
                    }else{
                        if (isset($Options['login_screen']['height']))
                        {
                            $getImageHeight = $Options['login_screen']['height'];
                        }
                    }
                }
                ...
                <td>
                    ...
                    <input type="hidden" class="wil-fix get_image_height" name="login_screen[height]" value="<?php echo (int)$getImageHeight;  ?>">
                </td>
            ...
            <tr valign="top">
                <?php $field="button_bgcolor";
                $val=(isset($Options['login_screen'][$field]))? $Options['login_screen'][$field]:0;
                ?>
                <th scope="row"><label for="<?php echo $field;?>"><?php _e('Button background color',self::LANG);?></label></th>
                <td>
                    <input type="text" class="choosecolor login_button_bgcolor" style="margin-top: -10px;" id="<?php echo $field;?>" name="login_screen[<?php echo $field;?>]" value="<?php echo $val;?>"  >
                    <input type="hidden" class="custom_color" name="login_screen[<?php echo $field;?>]" value="<?php echo $val;?>"  >
                </td>

            </tr>
            <tr valign="top">
                <?php $field="button_textcolor";
                $val=(isset($Options['login_screen'][$field]))? $Options['login_screen'][$field]:0;
                ?>
                <th scope="row"><label for="<?php echo $field;?>"><?php _e('Button text color',self::LANG);?></label></th>
                <td>
                    <input type="text" class="choosecolor button_textcolor" style="margin-top: -10px;" id="<?php echo $field;?>" name="login_screen[<?php echo $field;?>]" value="<?php echo $val;?>"  >
                    <input type="hidden" class="custom_color" name="login_screen[<?php echo $field;?>]" value="<?php echo $val;?>"  >
                </td>

            </tr>
            <tr valign="top">
                <?php $field="button_bordercolor";
                $val=(isset($Options['login_screen'][$field]))? $Options['login_screen'][$field]:0;
                ?>
                <th scope="row"><label for="<?php echo $field;?>"><?php _e('Button border color',self::LANG);?></label></th>
                <td>
                    <input type="text" class="choosecolor button_bordercolor" style="margin-top: -10px;" id="<?php echo $field;?>" name="login_screen[<?php echo $field;?>]" value="<?php echo $val;?>"  >
                    <input type="hidden" class="custom_color" name="login_screen[<?php echo $field;?>]" value="<?php echo $val;?>"  >
                </td>
